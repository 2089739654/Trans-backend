...
import com.example.trans_backend_socket.util.MqUtil;
...
public class EditEventWorkHandler implements WorkHandler<DisruptorEvent> {
    ...
    public EditEventWorkHandler (WebSocketHandler webSocketHandler){
...
//        saveMessage.setUserId(textEditMessage.getUser().getId());
//        saveMessage.setTransText(textEditMessage.getTransText());
//        saveMessage.setTimestamp(textEditMessage.getTimestamp());
//        saveMessage.setTransId(textEditMessage.getTransId());
//        MqUtil.sendMessage(saveMessage);
